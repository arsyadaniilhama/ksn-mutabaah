import type { AmalanKategori, ValueType } from "@/types";

/**
 * Master 19 kategori amalan Mutabaah KSN.
 * Sumber: sheet "Mutabaah" kolom Amalan/Ibadah + Keterangan.
 * value_type: 'rakaat' -> stepper angka; 'binary' -> slide toggle Ya/Tidak.
 */
export const AMALAN: AmalanKategori[] = [
  ...
  { id: 3, nama: "Sholat Shubuh", keterangan: "Datang sebelum adzan", value_type: "binary", urut: 3 },
  ...
  { id: 8, nama: "Sholat Zuhur", keterangan: "Datang sebelum adzan", value_type: "binary", urut: 8 },
  { id: 9, nama: "Dzikir Sholat Ba'da Zuhur", keterangan: null, value_type: "binary", urut: 9 },
  { id: 10, nama: "Sholat 'Asar", keterangan: "Datang sebelum adzan", value_type: "binary", urut: 10 },
  ...
  { id: 13, nama: "Sholat Maghrib", keterangan: "Datang sebelum adzan", value_type: "binary", urut: 13 },
  { id: 14, nama: "Dzikir Sholat Ba'da Maghrib", keterangan: null, value_type: "binary", urut: 14 },
  { id: 15, nama: "Sholat Isya'", keterangan: "Datang sebelum adzan", value_type: "binary", urut: 15 },
